                ...
                <div className="card flex-row justify-content-between mb-3 pt-3 pb-3 border-0" >
                  ...
                  <img className="" src={book.image} alt="" />
                    <div className="card-footer bg-white border-0 p-0" style={{
                      ...
                      <div className="book-title mt-3">
                        <p>{book.Title}</p>
                        <span style={{ fontSize: '10px' }}>{book.author}, {new Date(book.published).getFullYear().toString()}</span>
                      </div>
                      <div className="book-rating mt-2">
                        <span style={{ fontSize: '10px' }}>{book.rating}<span className="max-rating">/100</span></span>
                      </div>
                    </div>
                  </div>
                  <div className="card-block px-2 bg-white">
                    ...
                    <div className="d-flex flex-column">
                      <button className="btn btn-success mt-4">Borrowed</button>
                      <div className="btn-group">
                        <button className="btn btn-outline-primary mt-3">Read</button>
